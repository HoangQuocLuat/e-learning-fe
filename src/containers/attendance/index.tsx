...
const AttendanceContainer: React.FC = () => {
  ...
  const stopCamera = () => {
    if (videoRef.current && videoRef.current.srcObject) {
      ...
      tracks.forEach(track => track.stop()) // Dừng tất cả các track của stream
      videoRef.current.srcObject = null // Xóa stream khỏi videoRef
    }
  }
    ...
    <Wrap>
      ...
      <Modal
        ...
        onCancel={() => {
          ...
          stopCamera() // Tắt camera khi đóng modal
        }}
        footer={null}
        width={900}
      >
